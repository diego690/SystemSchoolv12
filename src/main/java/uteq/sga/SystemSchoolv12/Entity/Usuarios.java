...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.findByNombreusuarioAndPassusuario", query = "SELECT u FROM Usuarios u WHERE u.nombreusuario = :nombreusuario and u.passusuario = :passusuario"),
